    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('pattern')) {
                ...
                if (value !== '' && !pattern.test(value)) {
                    showError(input, input.getAttribute('title') || 'Invalid format');
                    return false;
                }
            }
        ...
        contactForm.addEventListener('input', function(e) {
            if (e.target.matches('input, textarea, select')) {
                const existingError = e.target.parentElement.querySelector('.error-message');
                if (existingError && e.target.value.trim() !== '') {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '8ca050e7-70a1-431a-857a-f9ae5ed04c41',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '8ca050e7-70a1-431a-857a-f9ae5ed04c41';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '8ca050e7-70a1-431a-857a-f9ae5ed04c41';
